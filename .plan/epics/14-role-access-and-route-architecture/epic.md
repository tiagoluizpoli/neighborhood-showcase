...
| --- | --- | --- | --- | --- |
| T-14-01 | Canonical Provider-enabled access contract | ready | — | `.plan/epics/14-role-access-and-route-architecture/tasks/01-canonical-provider-enabled-contract.md` |
