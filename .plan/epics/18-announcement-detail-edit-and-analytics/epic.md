...
| --- | --- | --- | --- | --- |
| T-18-01 | Extract shared AnnouncementForm and field-policy seam | ready | — | `.plan/epics/18-announcement-detail-edit-and-analytics/tasks/01-extract-shared-announcement-form-and-field-policy-seam.md` |
...
| T-18-05 | Test matrix and boundary guards | ready | T-18-01, T-18-02, T-18-03, T-18-04 | `.plan/epics/18-announcement-detail-edit-and-analytics/tasks/05-test-matrix-and-boundary-guards.md` |
