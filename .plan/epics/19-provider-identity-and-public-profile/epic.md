...
| T-19-02 | Original-image retention backend slice | in-progress | — | `.plan/epics/19-provider-identity-and-public-profile/tasks/02-original-image-retention-backend.md` |
