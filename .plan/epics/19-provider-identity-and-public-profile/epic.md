...
| --- | --- | --- | --- | --- |
| T-19-01 | Shared identity-precedence helper | ready | — | `.plan/epics/19-provider-identity-and-public-profile/tasks/01-shared-identity-precedence-helper.md` |
| T-19-02 | Original-image retention backend slice | ready | — | `.plan/epics/19-provider-identity-and-public-profile/tasks/02-original-image-retention-backend.md` |
| T-19-03 | Role-parameterized ImageUploadField with re-crop | ready | T-19-02 | `.plan/epics/19-provider-identity-and-public-profile/tasks/03-role-parameterized-image-upload-field.md` |
