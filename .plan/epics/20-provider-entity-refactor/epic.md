...
| --- | --- | --- | --- | --- |
| T-20-01 | Provider table, re-key migration, domain/repo plumbing, seed rebuild | in-progress | — | `.plan/epics/20-provider-entity-refactor/tasks/01-provider-table-rekey-and-seed.md` |
