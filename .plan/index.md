...
| T-20-04 | E-20 | Layered auth — global role + provider-scoped gating | done | T-20-01 | `.plan/epics/20-provider-entity-refactor/tasks/04-layered-auth.md` |
| T-20-05 | E-20 | Panel `$providerId` routing + My Providers + switcher + onboarding | in-progress | T-20-01, T-20-04 | `.plan/epics/20-provider-entity-refactor/tasks/05-panel-routing-and-my-providers.md` |
