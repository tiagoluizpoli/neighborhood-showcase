  ...
  async findPublicProviderById(
    ...
    const [row] = await db
      .select({
        ...
        logoOriginalUrl: providerProfileSchema.logoOriginalUrl,
        bannerUrl: providerProfileSchema.bannerUrl,
        bannerOriginalUrl: providerProfileSchema.bannerOriginalUrl,
    ...
    return {
      ...
      logoOriginalUrl: row.logoOriginalUrl ?? null,
      bannerUrl: row.bannerUrl ?? null,
      bannerOriginalUrl: row.bannerOriginalUrl ?? null,
